  ...
  extends StateFormItem<StateForm, IStateFormItemSelectOption>
{
  ...
  get formControlProps(): FormControlProps {
    const variantFromItemProps = typeof this.itemState.props?.variant === 'string'
      ? this.itemState.props.variant
      : undefined
    const variant = variantFromItemProps === 'filled'
      || variantFromItemProps === 'outlined'
      || variantFromItemProps === 'standard'
      ? variantFromItemProps
      : 'standard'
